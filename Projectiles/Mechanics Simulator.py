...
class CollisionsTwoParticlesInputs(tk.Frame):
    ...
    def __init__(self, master, switch_frame_callback):
        ...
        tk.Label(self, text='In this simulation the window is 400m by 300m and the particles will spawn in 50m from '
                            'each-other in the centre of the screen \n Positive velocity for particle 1 is taken to be to the right and to the left for particle 2 \n'
                            'The larger red particle is particle 1 and the smaller blue particle is particle 2').grid(row=1, column=10)
