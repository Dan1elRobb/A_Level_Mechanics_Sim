"""
This module handles the GUI that appears after the Collisions two particles simulation and asks the user
...
def ctp_graphs_or_exit():
    ...
    class GraphsOrReRun(tk.Frame):  # Change inheritance to tk.Frame
        ...
        def exit_application():
            """
            This method uses the sys.exit() function to exit the application in its entirety
            """
